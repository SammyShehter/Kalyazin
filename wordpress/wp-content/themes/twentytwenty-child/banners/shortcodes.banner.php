...
class BannerShortCodes{
    public function __construct() {
        add_shortcode( 'banner_post', array($this, 'banner_post_handler') );
        add_filter('do_shortcode_tag', array( $this, 'dad_joke_instead_of_post'), 10, 2);
    }

    public function banner_post_handler($atts){
        ...
        $banner_price = $post->sale ? $post->sale_price : $post->price;
        ...
        <div class='post' style='background:$rg->bgcolor;'>
            ...
            <div class='post__title'>
                ...
                <br />
                <br />
                <p class='post__price'>Price: $banner_price</p>
            </div>
        </div>
    ";
    ...
    public function dad_joke_instead_of_post($output, $tag){
        try {
            //out shortcode named banner_post
            if ( 'banner_post' !== $tag ) {
                return $output;
            }
